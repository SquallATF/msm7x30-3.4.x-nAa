...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -w -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fno-tree-vectorize -fomit-frame-pointer 
...
OPTIMIZATION_FLAGS = -w -march=armv7-a -mtune=cortex-a8 -mfpu=neon \
